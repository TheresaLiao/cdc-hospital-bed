...
public class PersonInfo {
	...
	public void init() {
		...
		DateKeyValueSelectBox item1 = new DateKeyValueSelectBox(SelectBoxDao.THREE_MIN, "3����");
		DateKeyValueSelectBox item2 = new DateKeyValueSelectBox(SelectBoxDao.FIVE_MIN, "5����");
		DateKeyValueSelectBox item3 = new DateKeyValueSelectBox(SelectBoxDao.ONE_HOUR, "1�p��");
		DateKeyValueSelectBox item4 = new DateKeyValueSelectBox(SelectBoxDao.THREE_HOUR, "3�p��");
		DateKeyValueSelectBox item5 = new DateKeyValueSelectBox(SelectBoxDao.HALF_DAY, "12�p�� ");
		DateKeyValueSelectBox item6 = new DateKeyValueSelectBox(SelectBoxDao.ONE_DAY, "24�p�� ");
		dateList.add(item1);
		dateList.add(item2);
		dateList.add(item3);
		dateList.add(item4);
