	...
	public void doAfterCompose(Div comp) throws Exception {
		...
		if (totalNewsScore > earlyWarningScore) {
			comp.setStyle(" border-top-color: #ff0000; " + "border-right-color: #ff0000;"
					+ "border-bottom-color: #ff0000; " + "border-left-color: #ff0000; " + "border-width: 5px; z-window-content padding: 0px;");
		} else {
			comp.setStyle(" border-top-color: #d9d9d9; " + "border-right-color: #d9d9d9;"
					+ "border-bottom-color: #d9d9d9; " + "border-left-color: #d9d9d9; " + "border-width: 1px; z-window-content padding: 0px;");
		}
